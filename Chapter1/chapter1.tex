...
\begin{figure}
\centering
\includegraphics[scale=0.6]{Chapter1/chemistry1.png}
\caption{A single  strand of RNA showing the  main chemical entities
which compose it; base, sugar, and backbone.  The four bases (A, G, C,
U) are colored according to the NDB (Nucleic Acid Database) convention
\cite{ndburl},  the   backbone  is   colored  gray,  and   the  sugars
black. This figure is a copy  of Figure 2.1, in Wolfram Saenger's book
\cite{saenger1984}}
...
\begin{figure}
\centering
\includegraphics[scale=1.4, angle=90]{Chapter1/saenger28.png}
