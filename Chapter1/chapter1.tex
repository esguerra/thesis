...
\index{RNA folding} problem, that is, from primary sequence, finding in an
...
folding pathway. The \index{RNA folding} problem is usually seen as
...
\subsection{Is RNA folding a hard or easy problem?}
...
\subsection{Experimental folding techniques}
...
%Also relationship between pairing and secondary and tertiary
%structure and between paired steps and secondary to tertiary jump.
