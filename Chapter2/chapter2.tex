...
deviation (RMSD) between the average of step parameters 



clustered groups and the base-steps
parameters of  the 23S  subunit (PDB\_ID:1JJ2).  Before  computing the
RMSD  values we  normalize the  step  parameters by  taking the  ratio
between  the  step-parameters  and  their  minimum  value,  and  their
range. This is expressed in Equation~\ref{eq:normalization}



between the average normalized step
parameters of the  structures composing each of the  seven groups, and
the normalized \footnote{For normalization

  


} step-parameters of the
