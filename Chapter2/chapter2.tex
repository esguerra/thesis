...
In order to analyze our dataset of base-step parameters we must choose
a methodology. We have used the clValid from R to analyze a variety of
clustering methods in order to choose one. We can  see from diagrams
that the best is hierarchical clustering.

We have then split the data into A-RNA like, and non-ARNA.
The A-RNA group has about 70 percent of the data.
