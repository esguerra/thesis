...
\end{figure}
%
% Looking at  the previous  plot, it's clear  that you can  have clear
% steps which differentiate from  A-RNA steps, and which are recurrent
% structurally, just look at every  other parameter but slide, and you
% see  that  a  new  peak  in  the histogram  drawn  in  the  diagonal
% appears. It would be good to explore this fact, at the step
% level alone in a more thorough manner.
%
