...
Can   the  geometric  rigid-block   description  of
base-pairing  and base-stacking  solve the  problem of  defining RNA
structural motifs?

The  problem of  defining RNA structural  motifs is
clearly more complicated than what can be understood by anyone
structural  research   methodology  alone,  such   as  the  backbone
torsions, or the all-atom fitting.  We have shown
that  the  rigid-body   parameters  relating  sequential  base-pairs
facilitate motif searches in RNA atomic structures as well as in
the rigorous description of structural motifs. We believe
that this type of characterization should prove useful to the
community interested in ontological characterization of RNA.


Can we use quantities derived from the 3DNA software
...
Yes. by defining seeds from known motifs we can find
