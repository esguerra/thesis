...
downloaded  from the  Nucleic Acid  Database (NDB)  or PDB.  This file
contains  the  experimentally  derived  Cartesian coordinates  of  the
atoms. With this experimental data one performs a least-squares fit to
a standard  reference frame \cite{olson2001}.  This can be  done using
the               \textsf{octave}               script              at
